...
function getPageTitle(pathname: string): string {
  if (pathname.startsWith('/student/courses/') && pathname.includes('/quiz/')) {
    return 'Quiz';
  }
  if (pathname.startsWith('/student/courses/')) return 'Course Player';
            ...
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-2 rounded-md px-2 py-1.5 text-sm transition-colors hover:bg-accent">
                ...
                <div className="hidden flex-col items-start md:flex">
                  ...
                  <span className="text-xs leading-tight text-blue-500 font-medium">
                    Student
                  </span>
                </div>
