...
function getPageTitle(pathname: string): string {
  return routeTitles[pathname] ?? 'Auditor Portal';
}
            ...
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-2 rounded-md px-2 py-1.5 text-sm transition-colors hover:bg-accent">
                <Avatar className="h-7 w-7">
                  ...
                  <AvatarFallback className="bg-teal-100 text-xs text-teal-700 font-semibold">
                ...
                <div className="hidden flex-col items-start md:flex">
                  ...
                  <span className="text-xs leading-tight text-teal-600 font-medium">
                    Auditor
                  </span>
                </div>
